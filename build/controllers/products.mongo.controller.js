...
const createProduct = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const savedItem = yield models_1.ProductSchema.create(newProduct);
...
const updateProduct = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        let product = yield models_1.ProductSchema.findById(id);
        if (!product) {
        ...
        ;
        yield models_1.ProductSchema.updateOne({ _id: id }, req.body);
        res.status(http_status_1.default.OK).json({
            success: true,
            data: yield models_1.ProductSchema.findById(id),
        });
    }
    catch (error) {
        next(error);
...
const deleteProduct = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        ;
        yield models_1.ProductSchema.deleteOne({ _id: id });
        res.status(http_status_1.default.OK).json({
            success: true,
